...
BATCH_SIZE = 8 #  can change batch size for EDSR 8 is good
EPOCHS = 100 # Reduce for quick testing
TARGET_SIZE = (256, 256)
NUM_RUNS = 3 # Reduce for quick testing
...
# --- Medical Image Dataset Creation---
